...
function saveWebForm(){
	...
	function addNewOption(obj){
		var html = '<p class="optionHolder"><input type="text" class="form-control fieldOptions" id="optionHolders" placeholder="Enter option label"><img src="images/minus.png" id="minus" title="Delete option" alt="Delete option" onclick="deleteFieldOption(this)"></p>';
	...
	function createCustomField(){
		var html  = '<div class="fieldSection">';
				html  += '<div class="col-md-12 padding_left">';
					html += '<div class="col-md-4 padding_left">';
					...
					html += '<label id="crodd_img"><img src="images/cross.png" alt="Remove" title="Remove" onclick="removeField(this)"></label>';
					html += '</div>';
				html += '</div>';
