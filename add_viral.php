                                        ...
                                        <div class="panel-collapse sms_texts_section display-block" aria-expanded="true">
                                            <div class="portlet-body padding-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="code_message" parsley-trigger="change" required placeholder="Enter sms text to share unique code with friends to make their own chain" class="form-control textCounter"><?php echo $row['code_message']?></textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="notification_msg" parsley-trigger="change" required placeholder="Enter sms text that will notify user when some subscribe using his code" class="form-control textCounter"><?php echo $row['notification_msg']?></textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="winning_number" parsley-trigger="change" required placeholder="Winning number" class="form-control" value="<?php echo !empty($row['winning_number']) ? $row['winning_number'] : ''?>"/>
                                                </div>
